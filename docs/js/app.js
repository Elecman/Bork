...
var moduleForm = function () {
  ...
  var createMask = function createMask(elem) {
    if (!elem) {
      return;
    }
    ...
    var mask = new _imask2.default(phoneInput, maskOptions);
  };

  var checkInputs = function checkInputs(elem) {
    if (!elem) {
      return;
    }
  ...
  var validateInput = function validateInput(id, elem) {
    switch (id) {
      case 'phone':
  ...
  var sendForm = function sendForm(btnForm) {
